        ...
        <div class="container margin" style="    background-color:#c9c9e6; ">
            <div  class="row">
                <div class="col-sm">
                    ...
                    <%  try {
                            ConSQLAdmin.traerUsuarioMayorventa(fechaDe, fechaHasta);
                            while (ConSQLAdmin.rs.next()) {
                    %>
                    <h2>Usuario con mayor venta: <%=ConSQLAdmin.rs.getString(1)%>: <%=ConSQLAdmin.rs.getString(2)%> <%=ConSQLAdmin.rs.getString(3)%></h2>
                    <%
                            idUsuario = Integer.parseInt(ConSQLAdmin.rs.getString(1));
                        }
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <%
                                try {
                                    ConSQLAdmin.traerVentasMaxPorUsuario(idUsuario);
                                    while (ConSQLAdmin.rs.next()) {
