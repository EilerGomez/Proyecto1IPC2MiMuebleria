...
<html style="margin-left: 100px">
 ...
 <%
        ...
        <div class="container margin">
            <div  class="row">
                <div class="col-sm">
                    <form method="post"action="DelAdministrador/TablaUsuarioMaximaVentaXTiempo.jsp" >
                        <h2>INGRESA LOS DATOS DE FECHAS PARA CONSULTAR LAS VENTAS MAXIMAS</h2>
                        ...
                        <div class="mb-3">
                            ...
                            <a id="Consultar"><button type="submit" class="btn btn-primary" name="conusultarMaxVenta" onclick="Mensaje()">Consultar</button></a>
                        </div>
