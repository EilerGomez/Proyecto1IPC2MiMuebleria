        ...
        <div class="container margin" style="    background-color:#c9c9e6; ">
            <div  class="row">
                <div class="col-sm">
                    ...
                    <%  try {
                            ConSQLAdmin.traerMuebleMenosVendidoXtiempo(fechaDe, fechaHasta);
                            while (ConSQLAdmin.rs.next()) {
                    %>
                    <h2>Mueble Menos vendido: <%=ConSQLAdmin.rs.getString(1)%>; <%=ConSQLAdmin.rs.getString(2)%></h2>
                    <%
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <%
                                ...
                                ConSQLAdmin.traerDetallesMuebleMenosVendido(nombreMueble,fechaDe,fechaHasta);
                                while (ConSQLAdmin.rs.next()) {
