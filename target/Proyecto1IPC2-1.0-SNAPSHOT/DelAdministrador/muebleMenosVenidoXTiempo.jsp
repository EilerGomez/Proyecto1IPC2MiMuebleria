...
<html style="margin-left: 100px">
    <head>
        ...
        <title>Devolucion de compras</title>
    ...
    <body style="background-color:  #a398c1;;
        ...
        <div class="container margin">
            <div  class="row">
                <div class="col-sm">
                    <form method="post"action="DelAdministrador/tablaMuebleMenosVendioXtiempo.jsp" >
                        <h2>INGRESA LOS DATOS DE FECHAS PARA CONSULTAR EL MUEBLE MENOS VENDIDO</h2>
