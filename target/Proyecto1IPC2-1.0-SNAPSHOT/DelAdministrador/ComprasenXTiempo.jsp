...
<html style="margin-left: 100px">
    ...
    <body style="background-color:  #a398c1;;
        ...
        <div class="container margin">
            <div  class="row">
                <div class="col-sm">
                    <form method="post"action="DelAdministrador/tablaVentasXTiempo.jsp" >
                        <h2>INGRESA LOS DATOS DE FECHAS PARA CONSULTAR LAS COMPRAS</h2>
                        ...
                        <div class="mb-3">
                            ...
                            <a id="Consultar"><button type="submit" class="btn btn-primary" name="consultarVentaXtiempo" onclick="Mensaje()">Consultar</button></a>
                        </div>
